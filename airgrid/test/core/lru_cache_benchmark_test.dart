...
void main() {
  group('LruCache Performance', () {
    test('benchmark: lazy expiration scales to large cache sizes', () {
      ...
      expect(lazyMicros, lessThan(100000), 
    ...
    test('benchmark: dirty counter cleanup amortizes cost', () {
      ...
      // ignore: avoid_print
      print('Lazy cleanup triggered (1000 entries): ${stopwatch.elapsedMicroseconds}\u03bcs');
    ...
    test('benchmark comparison: O(1) lookup vs O(n) scan', () {
      ...
      for (final size in sizes) {
        ...
        // ignore: avoid_print
        print('Cache size $size: ${microsPerLookup.toStringAsFixed(2)}\u03bcs per lookup');
        ...
        expect(microsPerLookup, lessThan(100), 
